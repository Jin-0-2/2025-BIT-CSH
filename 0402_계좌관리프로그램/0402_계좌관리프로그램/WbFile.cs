...
namespace WSBit41JJY.File
{
    internal static class WbFile
    {
        ...
        public static void Write_Account(WbArray accounts)
        {
            StreamWriter writer = new StreamWriter(ACCOUNTS_FILENAME);
            writer.WriteLine(accounts.Size);
        ...
        public static void Write_Accountio(WbArray accountios)
        {
            StreamWriter writer = new StreamWriter(ACCOUNTIOS_FILENAME);
            writer.WriteLine(accountios.Size);
