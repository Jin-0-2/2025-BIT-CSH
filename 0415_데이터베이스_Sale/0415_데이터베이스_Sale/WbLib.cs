...
namespace _0415_데이터베이스_Sale
{
    internal class WbLib
    {
        ...
        public static void Logo()
        {
            ...
            Console.WriteLine(" 계좌 관리 프로그램 (SALE)");
        ...
        public static ConsoleKey MenuPrint()
        {
            ...
            Console.WriteLine("[F1] 주문 내역 저장");
            Console.WriteLine("[F2] 주문 내역 삭제(고객 이름, 도서 이름)");
            Console.WriteLine("[F3] 주문 내역 검색(고객 이름)");
            Console.WriteLine("[F4] 주문 내역 수정(고객 이름)");
            Console.WriteLine("[F5] Best Seller");
            Console.WriteLine("[F6] Total Sale Price");
            Console.WriteLine("*************************************************************************");
