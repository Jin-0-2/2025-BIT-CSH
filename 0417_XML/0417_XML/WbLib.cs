...
namespace _0415_데이터베이스
{
    internal class WbLib
    {
        ...
        public static void Logo()
        {
            ...
            Console.WriteLine(" 계좌 관리 프로그램 (XML 저장)");
            Console.WriteLine(" 2025-04-17");
        ...
        public static ConsoleKey MenuPrint()
        {
            ...
            Console.WriteLine("[F2] 계좌 입금");
            Console.WriteLine("[F3] 계좌 출금");
            Console.WriteLine("[F4] 계좌 삭제");
            Console.WriteLine("[F5] 전체 계좌 출력");
            Console.WriteLine("[F6] XML로 저장");
            Console.WriteLine("[F7] XML로 읽기");
            Console.WriteLine("*************************************************************************");
