...
namespace _0421_HarryPotter
{
    internal class WbLib
    {
        ...
        public static ConsoleKey MenuPrint()
        {
            ...
            Console.WriteLine("[F1] 호그와트 입학(Insert)");
            Console.WriteLine("[F2] 이름 검색");
            Console.WriteLine("[F3] 기숙사 검색");
            Console.WriteLine("[F4] 남자/여자 검색");
            Console.WriteLine("[F5] 종 검색");
            Console.WriteLine("[F6] 생존자/사망자 검색");
            Console.WriteLine("*************************************************************************");
