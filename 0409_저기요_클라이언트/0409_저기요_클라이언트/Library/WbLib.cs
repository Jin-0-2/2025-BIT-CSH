...
namespace WSBit41JJY.Lib
{
    internal static class WbLib
    {
        ...
        public static ConsoleKey Choose_S_L()
        {
            Console.Clear();
            Console.WriteLine("*************************************************************************");
            Console.WriteLine("1. 회원가입");
            Console.WriteLine("2. 고객 로그인");
            Console.WriteLine("3. 사장님 로그인");
            Console.WriteLine("*************************************************************************");
            return Console.ReadKey().Key;
        }
        public static ConsoleKey C_MenuPrint()
        {
            Console.WriteLine("*************************************************************************");
            Console.WriteLine("[ESC] 프로그램 종료");
            Console.WriteLine("[F1] 가게 선택");
            Console.WriteLine("[F2] 메뉴 선택");
            Console.WriteLine("[F3] 잔액 추가");
            Console.WriteLine("*************************************************************************");
            return Console.ReadKey().Key;
        }
        public static ConsoleKey O_MenuPrint()
        {
            Console.WriteLine("*************************************************************************");
            Console.WriteLine("[ESC] 프로그램 종료");
            Console.WriteLine("[F1] 메뉴 추가");
            Console.WriteLine("[F2] 주문 접수");
            Console.WriteLine("*************************************************************************");
            return Console.ReadKey().Key;
        }
        ...
        //public static int InputBool(string msg)
        //{
        //    Console.Write(msg + " : ");
